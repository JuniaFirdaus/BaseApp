...
class AppInteractor(private val iAppRepository: IAppRepository) : AppUseCase {
    override fun getAllTourism() = iAppRepository.getAllTourism()

    override fun getFavoriteTourism() = iAppRepository.getFavoriteTourism()

    override fun setFavoriteTourism(tourism: Tourism, state: Boolean) =
        iAppRepository.setFavoriteTourism(tourism, state)
